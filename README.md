...
Explore the high-resolution fractal plane via mouse, multitouch gestures, or keyboard. Fractals can be zoomed, panned, rotated, and changed in real-time.
...
## [Getting Started](https://github.com/rbrnka/fractal-traveler/wiki/Getting-Started)
## [Documentation](https://fractal.brnka.com/docs)
## [Changelog](https://github.com/rbrnka/fractal-traveler/wiki#changelog)

---
*By Radim Brnka © 2025–2026, Inspired by the intricate beauty of fractals, developed for interactive exploration and learning.*
